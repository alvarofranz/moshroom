...
- (void)_moshroom_updateTextInputTraits:(id <UITextInputTraits>)traits;
...
- (void)_moshroom_updateTextInputTraits:(id <UITextInputTraits>)traits {
  ...
  if ([mayBeUs isKindOfClass:[KBWebViewBase class]]) {
    ...
    [base _moshroom_updateTextInputTraits:traits];
  }
...
+ (void)load {
  ...
  IMP iml = class_getMethodImplementation(cls, NSSelectorFromString(@"_moshroom_updateTextInputTraits:"));
