...
typedef id<MoshSessionParamsSnapshotting, NSSecureCoding> MoshSessionParams;
...
@property (strong, atomic) MoshSessionParams sessionParams;
...
- (id)initWithDevice:(TermDevice *)device
            andParams:(MoshSessionParams)params;
