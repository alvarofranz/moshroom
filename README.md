...
<table>
  ...
  <tr>
    <td align="center"><img src="screenshots/driving-the-agent.png" width="220" alt="Terminal transcript with the coding agent picking up the prompt and the uploaded file paths"></td>
