...
let MOSHROOM_APP_FONT_NAME: String = Bundle.main.infoDictionary?["MOSHROOM_APP_FONT"] as? String ?? "JetBrains Mono"

public enum MoshroomSnippetsFonts {
  //  static let snippetIndex = Font.custom(MOSHROOM_APP_FONT_NAME, size: 18, relativeTo: .body)
  //  static let snippetContent = Font.custom(MOSHROOM_APP_FONT_NAME, size: 18, relativeTo: .body)
  static let snippetEditContent = UIFont(name: MOSHROOM_APP_FONT_NAME, size: 18)!
}
