...
public struct SSHClientConfig: CustomStringConvertible, Equatable {
  ...
  public init(user: String,
    ...
    self.logger = logger
    // 15s default: a mobile client should report a dead host quickly. Per-host
    // ssh-config ConnectTimeout still overrides.
    self.connectionTimeout = connectionTimeout ?? 15
