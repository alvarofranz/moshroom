...
function term_setup(accessibilityEnabled) {
  ...
  t.onTerminalReady = function() {
    ...
    if (_moshroomScreen) {
      ...
      _moshroomStyle.textContent = '*{-webkit-user-select:none!important;-webkit-touch-callout:none!important;caret-color:transparent!important;}';
    ...
    _moshroomCaretStyle.textContent = '*{caret-color:transparent!important;}';
